...
Most of these come down to network reality or how wikifeatured serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

wikifeatured rate-limits like any public site. wikifeatured already paces
...
Where a surface is gated, wikifeatured reads a cookie or token you supply
...
`wikifeatured`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what wikifeatured actually did
