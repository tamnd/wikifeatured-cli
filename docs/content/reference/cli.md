...
```
wikifeatured <command> [arguments] [flags]
```

Run `wikifeatured <command> --help` for the full flag list on any command. This
...
per operation you declare in `wikifeatured/domain.go`.
