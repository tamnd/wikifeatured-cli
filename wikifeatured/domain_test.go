...
// HTTP behaviour is covered in wikifeatured_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "wikifeatured://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("wikifeatured", "about")
	if err != nil || got.String() != "wikifeatured://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want wikifeatured://page/about", got.String(), err)
	}
}
